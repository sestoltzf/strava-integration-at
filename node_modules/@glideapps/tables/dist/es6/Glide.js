...
var Glide = /** @class */ (function () {
    function Glide(props) {
        ...
        this.props = {
            ...
            endpoint: (_b = props.endpoint) !== null && _b !== void 0 ? _b : defaultEndpoint,
            endpointREST: (_c = props.endpointREST) !== null && _c !== void 0 ? _c : defaultEndpointREST,
    ...
    Glide.prototype.api = function (route, r) {
        ...
        return fetch(this.endpoint(route), __assign(__assign({ method: "GET" }, r), { headers: __assign(__assign({ Authorization: "Bearer ".concat(token), "Content-Type": "application/json", Accept: "application/json" }, maybeClientIDObject), r.headers) }));
    };
