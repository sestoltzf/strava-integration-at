            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, mapChunks(renamedRows, constants_1.MAX_MUTATIONS, function (chunk) { return __awaiter(_this, void 0, void 0, function () {
                                var response, rowIDs;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            response = _a.sent();
                                            return [4 /*yield*/, (0, common_1.throwError)(response)];
                                        case 2:
                                            _a.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this.props, app = _a.app, table = _a.table;
                        return [4 /*yield*/, mapChunks(Object.entries(updates), constants_1.MAX_MUTATIONS, function (chunk) { return __awaiter(_this, void 0, void 0, function () {
                                var response;
                                var _this = this;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, app = _a.app, table = _a.table;
                        rows = Array.isArray(rowOrRows) ? rowOrRows : [rowOrRows];
                        return [4 /*yield*/, mapChunks(rows, constants_1.MAX_MUTATIONS, function (chunk) { return __awaiter(_this, void 0, void 0, function () {
                                var response;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.glide.post("/mutateTables", {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = this.props, app = _a.app, table = _a.table;
                        rows = [];
                        sql = rowIDOrQuery === null || rowIDOrQuery === void 0 ? void 0 : rowIDOrQuery(new QueryBuilder_1.QueryBuilder({
                            table: table,
