...
exports.appDefinition = exports.tableDefinition = void 0;
...
function columnNamesToObjectPropertyNames(columnNames) {
    ...
    for (var _i = 0, columnNames_1 = columnNames; _i < columnNames_1.length; _i++) {
        ...
        rename = (0, camelCase_1.default)(rename.replace(/[^a-zA-Z0-9_$]/g, "_"));
        if (!isValidIdentifier(rename)) {
            rename = (0, camelCase_1.default)("the_" + rename);
        }
        // Avoid conflicts
        var n = 1;
        var unique = rename;
...
function tableDefinition(glide, props, appValue, tables) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    schema = _b.sent();
                    src = "export const ".concat((0, camelCase_1.default)(table.name), " = ");
...
function appDefinition(glide, props) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (tables === undefined)
                        throw new Error("Could not get tables");
                    appName = (0, camelCase_1.default)(app.name);
                    src = preamble;
