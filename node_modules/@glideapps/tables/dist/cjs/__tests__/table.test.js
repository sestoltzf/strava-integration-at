...
describe("table", function () {
    ...
    it("can get rows", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, test_common_1.table.get()];
                case 1:
                    rows = _a.sent();
    ...
    it("can get more than 10k rows", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, test_common_1.bigBigTable.get()];
                case 1:
                    rows = _a.sent();
    ...
    it("can add a row", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, test_common_1.table.add({
                        name: "Test Item",
                ...
                case 1:
                    ...
                    return [4 /*yield*/, test_common_1.table.delete(rowID)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, test_common_1.table.delete(rowIDs)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    rowID = _a.sent();
                    expect(rowID).toBeDefined();
                    return [4 /*yield*/, test_common_1.table.update(rowID, { name: "Renamed" })];
                case 2:
                    _a.sent();
                    // wait to allow the row to be updated
                    return [4 /*yield*/, (0, test_common_1.sleep)(5000)];
                case 3:
                    // wait to allow the row to be updated
                    _a.sent();
                    return [4 /*yield*/, test_common_1.table.get(rowID)];
                case 4:
                    renamed = _a.sent();
    ...
    it("can clear columns", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, test_common_1.table.add({ name: "Delete me" })];
                case 1:
                    rowID = _a.sent();
                    return [4 /*yield*/, (0, test_common_1.sleep)(1000)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, test_common_1.table.update(rowID, { name: null })];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, (0, test_common_1.sleep)(1000)];
                case 4:
    ...
    it("can get schema", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, test_common_1.table.getSchema()];
                case 1:
