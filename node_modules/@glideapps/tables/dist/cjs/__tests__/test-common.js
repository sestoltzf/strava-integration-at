...
exports.sleep = exports.bigBigTable = exports.bigTable = exports.tableWithClient = exports.table = exports.appWithClient = exports.app = exports.glideStagingWithClient = exports.glideStaging = void 0;
require("dotenv").config();
var Glide_1 = require("../Glide");
exports.glideStaging = new Glide_1.Glide({
...
exports.glideStagingWithClient = new Glide_1.Glide({
    endpoint: "https://staging.heyglide.com/api/container",
    endpointREST: "https://functions.staging.internal.glideapps.com/api",
    token: process.env.GLIDE_CLIENT_TOKEN_STAGING,
    clientID: process.env.GLIDE_CLIENT_ID,
});
exports.app = exports.glideStaging.app({
    id: "mT91fPcZCWigkZXgSZGJ",
});
exports.appWithClient = exports.glideStagingWithClient.app({
    id: "mT91fPcZCWigkZXgSZGJ",
});
exports.table = exports.app.table({
...
exports.tableWithClient = exports.appWithClient.table({
    table: "native-table-MX8xNW5WWoJhW4fwEeN7",
    columns: {
        name: { type: "string", name: "Name" },
        stock: { type: "number", name: "Description" },
...
exports.bigTable = exports.app.table({
...
exports.bigBigTable = exports.app.table({
